...
\newcommand{\xreview}[1]{\textcolor{nicegray}{#1}}

\newcommand{\myopt}{\xopt{[Optional]}}
\newcommand{\myrev}{\xreview{[Review]}}
\newcommand{\myrevsession}[1]{\xreview{[Session {#1}]}}
...
\newcommand{\urlyoutube}[1]{%
\begin{tikzpicture}[baseline=(A.base)]%
  \node (1) [rounded rectangle, inner sep = 3pt, fill=bgcolorlight] (A) {\textcolor{textcoloremph}{\text{\scalebox{0.9}{\faYoutube}}\text{\footnotesize\,\href{https://www.youtube.com/embed/\detokenize{#1}?rel=0}{\detokenize{#1}}}}};%
\end{tikzpicture}%
}

\newcommand{\urlyoutubetime}[2]{%
\begin{tikzpicture}[baseline=(A.base)]%
  \node (1) [rounded rectangle, inner sep = 3pt, fill=bgcolorlight] (A) {\textcolor{textcoloremph}{\text{\scalebox{0.9}{\faYoutube}}\text{\footnotesize\,\href{https://www.youtube.com/embed/\detokenize{#1}?rel=0&start=#2}{\detokenize{#1}}}}};%
\end{tikzpicture}%
}
...
\newcommand{\termdisplay}[1]{\textcolor{textcoloremph}{\scalebox{0.9}{\faHashtag}}}
...
\newcommand{\myterm}[1]{%
\raisebox{0pt}[0pt][0pt]{\pagetarget{\termlabel{#1}}{\termdisplay{#1}}}\termformat{#1}%
\only<1>{%
\additem{mytermlist}{%
...
%---------------------------------------------------------
% loading URL from a file, often due to special characters like #
%---------------------------------------------------------
\newcommand\myhrefFromFile[1]{%
    \CatchFileDef\myurl{#1}{\catcode`\#=12\catcode`\%=12\endlinechar=-1}%
    \expandafter\myhref\expandafter{\myurl}}


% \begin{filecontents*}{gp.txt}
% https://cvxopt.org/userguide/solvers.html#geometric-programming
% \end{filecontents*}

% \myhrefFromFile{gp.txt}{cvxopt.org/userguide/solvers.html\#geometric-programming}